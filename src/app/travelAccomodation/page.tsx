...
export default function TravelAccomodation() {
	...
	const guestListSearch = () => {
		return (
			<form className="page-t&a-name-search" onSubmit={handleSearchSubmit}>
	...
	return (
		<div className="page-t&a">
			<h1 className="page-t&a-title">Travel and Accomodation</h1>
			{guestListSearch()}
			{guestFullName ? (
				<>
					<h2 className="page-t&a-title">Hello {guestFullName}</h2>
					<form className="page-t&a-form" onSubmit={handleRsvpSubmit}>
						{sectionAttendance()}
						{isAttending ? (
							sectionDietry()
						) : (
						...
						<button type="submit" className="page-t&a-submit-button">
							Submit
						</button>
					</form>
				</>
