...
export default function Schedule() {
	...
	const guestListSearch = () => {
		return (
			<form className="page-schedule-name-search" onSubmit={handleSearchSubmit}>
	...
	return (
		<div className="page-schedule">
			<h1 className="page-schedule-title">Schedule</h1>
			{guestListSearch()}
			{guestFullName ? (
				<>
					<h2 className="page-schedule-title">Hello {guestFullName}</h2>
					<form className="page-schedule-form" onSubmit={handleRsvpSubmit}>
						{sectionAttendance()}
						{isAttending ? (
							sectionDietry()
						) : (
						...
						<button type="submit" className="page-schedule-submit-button">
							Submit
						</button>
					</form>
				</>
