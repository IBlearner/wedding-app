			...
			<div className="page-schedule">
				<div className="schedule-record">
					...
					<p className="schedule-text2">
						Please arrive around 2:30pm for a 3pm ceremony start in the <b>Stamford Plaza</b> Main Garden. This will be followed by <b>Group Photos</b> before making your way to the Pre-Reception area for canapés.
					</p>
				</div>
				<div className="schedule-record">
					...
					<p className="schedule-text2">Canapés will commence at 4:30pm. At this time any drinks will be self-service until the reception begins.</p>
				</div>
				<div className="schedule-record">
